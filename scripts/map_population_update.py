class MapData():
    ...
    def updated_population_count(self):
        """
        This validates whether the data has been
        updated with the population and updated column per row

        Returns boolean: check whether the list has been updated (true)
        or not (false)
        """
    ...
    def add_population(self, pop_map):
        ...
        Using this information, it updates each row entry to include the population
